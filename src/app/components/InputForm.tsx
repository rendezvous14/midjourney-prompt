...
export default function InputForm() {
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto" data-testid="input-form">
      <h1
      ...
      <div
        className="mt-4 p-3 border rounded bg-gray-100 flex items-center justify-between"
      ...
      {copied && (
        <div
          className="mt-2 p-2 bg-green-500 text-white rounded text-center"
